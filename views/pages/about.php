...
<? ob_start() ?>
  <div class="app-about">
    ...
    <div class="app-about-description">
      ...
      <p class="app-about-description__graph">Vous aussi devenez un super-héros du quotidien ou demandez l'aide d'un super-héros. N'attendez plus, inscrivez-vous !</p>
